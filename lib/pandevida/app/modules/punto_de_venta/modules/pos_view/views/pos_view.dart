...
class PosView extends GetView<PosViewController> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      ...
      body: Column(
        children: [
          // Contenido DESLIZABLE - incluye banner, cámara, botones y lista
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  // Título con información del carrito y subinventario - AHORA DESLIZABLE
                  Container(
                      ...
                      return Column(
                        children: [
                          ...controller.cartItems
                              ...
                              .toList(),
                          const SizedBox(height: 500), // Espacio para evitar que el BottomBar tape los productos
                        ],
                      );
                    },
                  ),
